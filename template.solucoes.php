...
<section class="d-flex p-5 flex-column align-items-center justify-content-center relative" id="solucoes-home" style="background-image: url('<?= the_post_thumbnail_url()?>');background-position-x:center;background-size:cover;background-repeat:no-repeat; ">
...
<section id="solucoes-info" class="relative bg-black d-flex align-items-center" style="background-image:url('<?= $base_url?>/assets/img/bg-solucoes-info.png');background-size:cover; background-repeat: no-repeat; background-postion-x:230px">
...
<section class="mx-0 mx-sm-5" style="margin-top: -3%;margin-bottom:-3%; z-index:9998; position:relative">
